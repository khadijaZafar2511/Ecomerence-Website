  ...
  return (
    <>
      <div className="flex flex-col  gap-1  shadow-gray-300 shadow-2xl   ">
        <div className=" h-80 md:h-70 sm:h-75 lg:h-70  bg-radial  from-[#c7c1B4] via-[#C4BEB0] to-[#9F9888] w-full  ">
          <img
        ...
        <h1 className=" px-1 text-base font-semibold">{data.title}</h1>

        <div className="flex justify-between  items-center mb-3">
          <p className=" px-1 text-sm text-gray-800 font-semibold">
            PKR {data.price}
          </p>
          <button
            onClick={() => {
